                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/kivicare-dist/documentation/html/forms/alternate-input.html" target="_blank">
                                    <svg width="20" className="me-1" viewBox="0 0 24 24" fill="none"
                        ...
                        <Tab.Content className='mt-2'>
                            <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-alternet-prv" role="tabpanel" aria-labelledby="typo-output">
                                <div className="bd-example">
                                    ...
                                    <Form.Group className="form-group form-group-filled input-group">
                                        <span className="input-group-text" id="group-input-1">@</span>
                                        <Form.Control type="text" placeholder="Addon" aria-label="Username" aria-describedby="group-input-1" />
                                    </Form.Group>
                                    <Form.Group className="form-group form-group-filled input-group">
                                        <Form.Control type="text" className="form-control" placeholder="Addon" aria-label="Recipient's username" aria-describedby="group-input-2" />
                                        <span className="input-group-text" id="group-input-2">@</span>
                                    </Form.Group>
                            ...
                            <Tab.Pane eventKey="second" className="tab-pane bd-heading-1 fade show" id="content-alternet-code" role="tabpanel" aria-labelledby="typo-output">
                                <div className="section-block">
                                    <pre className="language-markup"><code className="language-markup"> {`<div class="bd-example">
