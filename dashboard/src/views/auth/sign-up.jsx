                                ...
                                <Card.Body className="auth-card">
                                    ...
                                    <Form>
                                        <div className="custom-form-field">
                                            <Form.Group className="mb-5">
                                                <Form.Control type="email" className="mb-0" placeholder="Your email id *"></Form.Control>
                                            </Form.Group>
                                        </div>
                                        <p className="mb-5"> Your personal data will be used to support your
                                            experience throughout this
                                            website, manage access to your account, and serve other purposes
                                            described in our <Link to="/extra/privacy-policy"> Privacy
                                                Policy</Link>.
                                        </p>
                                        <Button href="#">
                                            <span className="text d-inline-block align-middle">Register</span>{" "}
                                    ...
                                    <div className="d-flex align-items-center mt-5 justify-content-center">
                                        <p className="text-center mb-0">
                                            <span className='signup-rtl-space'>Don't Have An Account Yet?</span>
