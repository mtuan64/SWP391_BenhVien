...
export default function PsychiatristPricing() {
    ...
    <div className="section-padding">
        <Container>
          <div className="text-center position-relative">
            <ScrollingText scrollTitle="pricing plan" />
            <Title subTitle="pricing plan" rightText="Plans That Helps You To Grow Your " leftText="Business" />
          </div>
