...
import { Col, Container, Row, Nav, Navbar, Dropdown, Form, Card, Button, Collapse } from 'react-bootstrap';
...
export default function HeaderProductHome({logoDynamic,IsMegaMenu}) {
  ...
  return (
    <Fragment>
      <header className="header-center-home">
        <div className="top-header bg-primary d-none d-md-block">
          <Container fluid>
            <div className="text-center">
                <span className="text-white">Sign up for 35% off your first order. <Link to="/shop/shop" className="text-white text-decoration-underline text-capitalize">subscribe</Link></span>
            </div>          
          </Container>
        </div>
...
<div className="right-panel">
                                ...
                                <ul className="navbar-nav align-items-center ms-auto mb-2 mb-xl-0">
                                        <Dropdown as="li" className="nav-item">
                                            ...
                                            <Dropdown.Menu className="p-0 sub-drop dropdown-menu-end" aria-labelledby="notification-drop" style={{ width: "20rem"}}  align={`${themeSchemeDirection === 'ltr' ? "end" : ""}`}>
