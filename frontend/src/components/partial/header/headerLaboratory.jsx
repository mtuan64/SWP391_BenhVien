...
export default function HeaderLaboratory({ logoDynamic, IsMegaMenu }) {
          ...
          <div className="top-header bg-dark d-none d-md-block">
            <Container fluid>
              <Row className="align-items-center">
                <Col md="6">
                  <span className="text-white font-size-14">Let’s begin the journey, click the button below to get started! </span>
                </Col>
                <Col md="6" className="text-end">
                  <span className="fw-500 font-size-14 text-white">Mon – Fri: 09:00AM – 5:00PM<span className="ps-4">  + 0800 24 66 721</span></span>
                </Col>
              </Row>
            </Container>
          </div>
