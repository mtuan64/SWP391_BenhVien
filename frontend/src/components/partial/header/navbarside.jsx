...
import { Col, Nav, Row, Navbar, Dropdown, Form, Card, Button, Container } from 'react-bootstrap';
...
const Navbarside = ({logoDynamic}) => {
  ...
  return (
    ...
    <Dropdown as="li" className="nav-item d-none d-xl-block">
        ...
        <Dropdown.Menu className="p-0 sub-drop dropdown-menu-end" aria-labelledby="notification-drop">
            <div className="form-group input-group mb-0 search-input">
                ...
                <span className="input-group-text">
                    <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <circle cxtoggle-rounded-btnLinecap="round" strokeLinejoin="round"></circle>
                        <path d="M18.0186 18.4851L21.5426 22" stroke="currentColor" strokeWidth="1.5"
                            strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
                </span>
            ...
            <Card className="m-0 shadow-none">
                <Card.Body className="p-0 max-17 scroll-thin">
                    {CartData.map((item, index) => (
                        <div className="iq-sub-card" key={index}>
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="text-primary"><i className="far fa-times-circle"></i></div>
                            </div>
                        </div>
                    ))}
                </Card.Body>
    ...
    <Dropdown as="li" className="nav-item">
        ...
        <Dropdown.Menu className="dropdown-menu dropdown-menu-end dropdown-user"
            ...
            <Dropdown.Item href="auth/login" className="border-bottom"> Sign in </Dropdown.Item>
            <Dropdown.Item href="auth/registration"> Sign up </Dropdown.Item>
        </Dropdown.Menu>
    </Dropdown>
