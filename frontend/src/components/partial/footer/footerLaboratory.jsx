...
//images
import footerlogo from '/assets/images/logo/lab-logo-white.png';

export default function FooterLaboratory() {
  ...
  return (
    <footer className="footer-laboratory">
      <div className="footer-top inner-box">
        <Container>
          <Row>
            <Col lg="3" md="6" className="px-3 px-lg-4">
              <div className="pe-lg-5">
                <Logo logoDynamic={true} logoImage={footerlogo} />
                <p className="mt-5 mb-4 text-white">subscribe us for get updated and stay tuned with us. </p>
                <MailBox isStyleBordered={true} />
                <SocialMedia customClass="mt-4 text-white" />
              </div>
            </Col>
            <Col lg="3" md="6" className="px-3 px-lg-4 mt-md-0 mt-5">
              <h5 className="mb-5 text-white">Quick Links</h5>
                  ...
                  <li className="mb-4">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div>
                        ...
                        <h5>
                          <Link to={'tel:+08002466721'} className="text-primary">+ 0800 24 66 721</Link>
                        </h5>
                      </div>
                    </div>
                  </li>
            ...
            <Col lg="3" md="6" className="px-3 px-lg-4 mt-lg-0 mt-5">
              <h5 className="mb-5 text-white">Working Hours</h5>
              <div className="mb-4">
                <span className="mb-2 d-block text-white">Monday - Friday :</span>
                <h6 className="m-0 text-primary text-uppercase">09:00 am - 7:00 pm</h6>
              </div>
              <div>
                <span className="mb-2 d-block text-white">Saturday - Sunday :</span>
                <h6 className="m-0 text-primary text-uppercase">Closed</h6>
              </div>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row className="align-items-center">
                <Col sm="6" className="text-sm-start text-center">
                  <p className="mb-0 text-white">© {currentYear} KiviCare All Rights Reserved.</p>
                </Col>
                <Col sm="6" className="text-sm-end text-center mt-sm-0 mt-2">
                    <a className="text-white" href="/privacy-policy">Privacy Policy </a>/ 
                    <a className="text-white" href="/terms-conditions"> Terms & Conditions</a>
                </Col>
          </Row>
        </Container>
      </div>
