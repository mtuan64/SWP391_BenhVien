...
export default function BlogOverdetails(props) {
  return (
    <div className="iq-blog blog-overdeatails">
      ...
      <div className="iq-post-details bg-white p-4 position-relative">
          ...
          <div className="iq-blog-meta mt-3">
            <ul className="list-inline">
                <li className="list-inline-item text-uppercase fw-500">
          ...
          <div className="blog-title">
            <Link href="/blog/blog-details">
                <h5 className="text-capitalize line-count-2">{props.blogTitle}</h5>
            </Link>
          </div>
