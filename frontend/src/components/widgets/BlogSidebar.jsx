                    ...
                    <div className="post-blog">
                        <ul className="list-inline mb-2">
                            <li className="list-inline-item border-0 mb-0 pb-0">
                              <Link to="/blog/blog-date"> <i className="far fa-calendar-alt me-1" aria-hidden="true"></i>{item.blogPublishDate}</Link>
                            </li>{" "}
                            <li className="list-inline-item border-0 mb-0 pb-0">
                        ...
                        <Link className="new-link" to="/blog/blog-details">
                            <h6 className="post-title mb-0">{item.blogTitle}</h6>
                        </Link>
                      </div>
                  </li>
                ))}
